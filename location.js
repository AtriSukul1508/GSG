...
const stateCard = [
    {
        ...
        touristSpot: [
            ...
            {
                "name": "Jantar Mantar",
                "images": "https://lh5.googleusercontent.com/p/AF1QipP7S33nyok9Srkc4Bh4ZMOKsCxMh6J4Bj1v3e1Y=w408-h305-k-no",
                "location": "https://www.google.co.in/maps/place/Jantar+Mantar+-+Jaipur/@26.9247668,75.8223713,17z/data=!3m1!4b1!4m5!3m4!1s0x396db14c7ff57069:0xe94a0429a18dabbe!8m2!3d26.924762!4d75.82456"
            },
            {
                "name": "Hawa Mahal",
    ...
    },
    {
        ...
        },
        {
            ...
            "images": "https://lh5.googleusercontent.com/p/AF1QipPyUeIn3hJhm8eW-87uBDYtGygMN0pMv7CDEsnq=w408-h408-k-no",
...
const showLocationInfo = (info) => {
    ...
    const containerContent = `<div class="container-section">
            <div class="navbar-section">
                <p>Profile</p>
                <a href="#" target="_blank"><i class="fa-solid fa-circle-user"></i></a>
                <button><i class="fa-solid fa-bars"></i></button>
                </div>
            <div class="home-section">
            <div class="leftside">
                    <h3>Find a Place to visit in ${info[2].stateName}</h3>
                    <h4>Discover Amazing Places</h4>
                    <a href="#">Search Your Destination</a>
                </div>
                <div class="rightside">
        ...
        <h1 class="heading">Tourist Place</h1>
        
        <div class="swiper tourist-slider">
        
                <div class="swiper-wrapper">

                <div class="swiper-slide slide">
                        <div class="image">
                            <img src="${info[2].touristSpot[0].images}" alt="">
                            </div>
                            <div class="content">
                            <h3>${info[2].touristSpot[0].name}</h3>
                            <div class="button-container">
                                <a href="#" class="btn">Visit</a>
                                <a href="${info[2].touristSpot[0].location}" target="_blank" class="btn">Get location</a>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide slide">
                        <div class="image">
                        <img src="${info[2].touristSpot[1].images}" alt="">
                        </div>
                        <div class="content">
                            <h3>${info[2].touristSpot[1].name}</h3>
                            <div class="button-container">
                                <a href="#" class="btn">Visit</a>
                                <a href="${info[2].touristSpot[1].location}" target="_blank" class="btn">Get location</a>
                                </div>
                                </div>
                                </div>
                                ...
                                <div class="swiper-slide slide">
                                <div class="image">
                                <img src="${info[2].touristSpot[2].images}" alt="">
                                </div>
                                <div class="content">
                                <h3>${info[2].touristSpot[2].name}</h3>
                            <div class="button-container">
                                <a href="#" class="btn">Visit</a>
                                <a href="${info[2].touristSpot[2].location}" target="_blank" class="btn">Get location</a>
                                </div>
                                </div>
                                </div>
                    ...
                    <div class="swiper-slide slide">
                    <div class="image">
                            <img src="${info[2].touristSpot[3].images}" alt="">
                        </div>
                        <div class="content">
                        <h3>${info[2].touristSpot[3].name}</h3>
                        <div class="button-container">
                        <a href="#" class="btn">Visit</a>
                                <a href="${info[2].touristSpot[3].location}" target="_blank" class="btn">Get location</a>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide slide">
                    <div class="image">
                    <img src="${info[2].touristSpot[4].images}" alt="">
                    </div>
                    <div class="content">
                    <h3>${info[2].touristSpot[4].name}</h3>
                        <div class="button-container">
                        <a href="#" class="btn">Visit</a>
                        <a href="${info[2].touristSpot[4].location}" target="_blank" class="btn">Get location</a>
                        </div>
                        </div>
                </div>
                ...
                <div class="swiper-slide slide">
                        <div class="image">
                            <img src="${info[2].touristSpot[5].images}" alt="">
                        </div>
                        <div class="content">
                            <h3>${info[2].touristSpot[5].name}</h3>
                            <div class="button-container">
                                <a href="#" class="btn">Visit</a>
                                <a href="${info[2].touristSpot[5].location}" target="_blank" class="btn">Get location</a>
                            </div>
                        </div>
                        </div>
        ...
        <div class="product-heading">Explore the Products</div>
        ...
        <h1 class="heading">Products</h1>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide">
                    <div class="image">
                            <img src="${info[2].products[0].image}" alt="">
                            </div>
                            <div class="content">
                            <h3>${info[2].products[0].name}</h3>
                            <div class="button-container">
                                ...
                                <div class="swiper-slide slide">
                    <div class="image">
                    <img src="${info[2].products[1].image}" alt="">
                    </div>
                    <div class="content">
                        <h3>${info[2].products[1].name}</h3>
                        <div class="button-container">
                        <a href="#" class="btn">Read More</a>
                        </div>
                        </div>
                ...
                <div class="swiper-slide slide">
                <div class="image">
                    <img src="${info[2].products[2].image}" alt="">
                    </div>
                    <div class="content">
                    <h3>${info[2].products[2].name}</h3>
                    <div class="button-container">
                    <a href="#" class="btn">Read More</a>
                    </div>
                    </div>
                    ...
                    <div class="swiper-slide slide">
                    <div class="image">
                    <img src="${info[2].products[3].image}" alt="">
                    </div>
                    <div class="content">
                    <h3>${info[2].products[3].name}</h3>
                <div class="button-container">
                <a href="#" class="btn">Read More</a>
                </div>
                </div>
        ...
        <div class="swiper-slide slide">
        <div class="image">
        <img src="${info[2].products[4].image}" alt="">
        </div>
        <div class="content">
            <h3>${info[2].products[4].name}</h3>
            <div class="button-container">
            <a href="#" class="btn">Read More</a>
            </div>
            </div>
            ...
            <div class="swiper-slide slide">
            <div class="image">
        <img src="${info[2].products[5].image}" alt="">
    </div>
    <div class="content">
    <h3>${info[2].products[5].name}</h3>
    <div class="button-container">
            <a href="#" class="btn">Read More</a>
        </div>
    </div>
        ...
        <div class="side-circle-2"></div>
        <div class="weather-heading">Weather</div>
        <section class="container-weather">
        <!-- <div class="weather-details"> -->
        <div class="location-info">
        <div class="city" id="city">${info[2].stateName}</div>
        <div class="date" id="date"></div>
        </div>
            <a href='https://www.freepik.com/vectors/education'><img src="Weather.jpg" alt=""></a>
            <div class="weather-status">
                <img src="" id="icon" alt="">
                <div class="temperature fa-solid fa-temperature-high" id="temperature"></div>
                <div class="minimum-maximum-temperature" id="minimum-maximum-temperature"></div>
                <div id="humidity" class="humidity fa-solid fa-umbrella"></div>
...
showLocationInfo(stateCard);

const weatherApi = {
    api_key: "806ffd9b8f5dbcf5bf255926853925a8",
    main_url: "https://api.openweathermap.org/data/2.5/weather",
}
const city = document.getElementById("city");
getWeatherReport(city.innerText);
function getWeatherReport(city) {
    fetch(`${weatherApi.main_url}?q=${city}&appid=${weatherApi.api_key}&units=metric`)
        .then(weather => {
            return weather.json();
...
function showWeatherReport(weather) {
    ...
    let minMaxTemp = document.getElementById('minimum-maximum-temperature');
    minMaxTemp.innerHTML = `${Math.floor(weather.main.temp_min)}&deg;C (min)/ ${Math.ceil(weather.main.temp_max)}&deg;C (max) `;
    let date = document.getElementById('date');
    let currentDate = new Date();
    date.innerText = dateCreate(currentDate);

}

function dateCreate(dateParams) {
    ...
    let month = months[dateParams.getMonth()];
    let date = dateParams.getDate();
    let day = days[dateParams.getDay()];

    return `${day}, ${date} ${month} ${year}`;
}
        // btn[i].href = "location.html";
    });
}